...
#ifndef __TEXTMESSAGE_M_H
#define __TEXTMESSAGE_M_H
...
/**
 * Class generated from <tt>Messages/TextMessage.msg:19</tt> by nedtool.
 * <pre>
 * //
 ...
 * </pre>
 */
class TextMessage : public ::omnetpp::cPacket
{
  protected:
    int someField;
  ...
  private:
    void copy(const TextMessage& other);
  ...
  public:
    TextMessage(const char *name=nullptr, short kind=0);
    TextMessage(const TextMessage& other);
    virtual ~TextMessage();
    TextMessage& operator=(const TextMessage& other);
    virtual TextMessage *dup() const override {return new TextMessage(*this);}
...
inline void doParsimPacking(omnetpp::cCommBuffer *b, const TextMessage& obj) {obj.parsimPack(b);}
inline void doParsimUnpacking(omnetpp::cCommBuffer *b, TextMessage& obj) {obj.parsimUnpack(b);}


#endif // ifndef __TEXTMESSAGE_M_H
